...
class appProdProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'domjudge.api_headers_listener' => 'getDomjudge_ApiHeadersListenerService',
            'domjudge.domjudge' => 'getDomjudge_DomjudgeService',
            'domjudge.user_checker' => 'getDomjudge_UserCheckerService',
            'domjudge.user_registration_validator' => 'getDomjudge_UserRegistrationValidatorService',
            ...
            'legacy.controller.fallback' => 'getLegacy_Controller_FallbackService',
            ...
            'security.firewall.map.context.feed' => 'getSecurity_Firewall_Map_Context_FeedService',
            ...
            'security.user.provider.concrete.domjudge_db_provider' => 'getSecurity_User_Provider_Concrete_DomjudgeDbProviderService',
    ...
    {
        return $this->services['assets._version__default'] = new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('v=6.0.3', '%s?%s');
    }
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('-Xj-u38TqE', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('hVcDN8xtU-', 0, 'ZzX3CJXmvlWHgjb3N4kh6F', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'dbname' => 'domjudge', 'user' => 'domjudge', 'password' => 'AFASTMgceilULG2J', 'charset' => 'utf8mb4', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/DOMJudgeBundle/Entity'))), 'DOMJudgeBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('DOMJudgeBundle' => 'DOMJudgeBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_adc6fe26e1f01352878d355c1a6b0fe87b28f2d7c1546b553d0788255614027e');
    ...
    /*
     * Gets the 'domjudge.api_headers_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \DOMJudgeBundle\EventListener\ApiHeadersListener A DOMJudgeBundle\EventListener\ApiHeadersListener instance
     */
    protected function getDomjudge_ApiHeadersListenerService()
    {
        return $this->services['domjudge.api_headers_listener'] = new \DOMJudgeBundle\EventListener\ApiHeadersListener();
    }

    /*
     * Gets the 'domjudge.domjudge' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \DOMJudgeBundle\Service\DOMJudgeService A DOMJudgeBundle\Service\DOMJudgeService instance
     */
    protected function getDomjudge_DomjudgeService()
    {
        return $this->services['domjudge.domjudge'] = new \DOMJudgeBundle\Service\DOMJudgeService($this->get('doctrine.orm.default_entity_manager'), $this->get('request_stack'), $this);
    }

    /*
     * Gets the 'domjudge.user_checker' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \DOMJudgeBundle\Security\UserChecker A DOMJudgeBundle\Security\UserChecker instance
     */
    protected function getDomjudge_UserCheckerService()
    {
        return $this->services['domjudge.user_checker'] = new \DOMJudgeBundle\Security\UserChecker();
    }

    /*
     * Gets the 'domjudge.user_registration_validator' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \DOMJudgeBundle\Validator\Constraints\UserRegistrationValidator A DOMJudgeBundle\Validator\Constraints\UserRegistrationValidator instance
     */
    protected function getDomjudge_UserRegistrationValidatorService()
    {
        return $this->services['domjudge.user_registration_validator'] = new \DOMJudgeBundle\Validator\Constraints\UserRegistrationValidator($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListenerService('kernel.response', array(0 => 'domjudge.api_headers_listener', 1 => 'onKernelResponse'), 0);
    ...
    {
        return $this->services['jms_serializer.datetime_handler'] = new \JMS\Serializer\Handler\DateHandler('Y-m-d\\TH:i:sP', 'Asia/Shanghai', true);
    }
    ...
    /*
     * Gets the 'legacy.controller.fallback' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \LegacyBundle\Controller\FallbackController A LegacyBundle\Controller\FallbackController instance
     */
    protected function getLegacy_Controller_FallbackService()
    {
        return $this->services['legacy.controller.fallback'] = new \LegacyBundle\Controller\FallbackController(($this->targetDirs[3].'/app/../../www'), $this);
    }
    ...
    {
        return $this->services['property_accessor'] = new \Symfony\Component\PropertyAccess\PropertyAccessor(false, false, \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('ai7habC1AO', NULL, 'ZzX3CJXmvlWHgjb3N4kh6F', $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('DOMJudgeBundle\\Entity\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\BCryptPasswordEncoder', 'arguments' => array(0 => 13))));
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/'), 'security.firewall.map.context.api' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/api'), 'security.firewall.map.context.feed' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/feed'), 'security.firewall.map.context.main' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/'))), $this->get('event_dispatcher'));
    }
    ...
    /*
     * Gets the 'security.firewall.map.context.feed' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Symfony\Bundle\SecurityBundle\Security\FirewallContext A Symfony\Bundle\SecurityBundle\Security\FirewallContext instance
     */
    protected function getSecurity_Firewall_Map_Context_FeedService()
    {
        $a = $this->get('security.token_storage');
        $b = ${($_ = isset($this->services['security.authentication.manager']) ? $this->services['security.authentication.manager'] : $this->getSecurity_Authentication_ManagerService()) && false ?: '_'};
        $c = $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE);
        ...
        return $this->services['security.firewall.map.context.feed'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => ${($_ = isset($this->services['security.channel_listener']) ? $this->services['security.channel_listener'] : $this->getSecurity_ChannelListenerService()) && false ?: '_'}, 1 => new \Symfony\Component\Security\Http\Firewall\BasicAuthenticationListener($a, $b, 'feed', $d, $c), 2 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '5cad6d05587b46.97074281', $c, $b), 3 => ${($_ = isset($this->services['security.access_listener']) ? $this->services['security.access_listener'] : $this->getSecurity_AccessListenerService()) && false ?: '_'}), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, ${($_ = isset($this->services['security.authentication.trust_resolver']) ? $this->services['security.authentication.trust_resolver'] : $this->getSecurity_Authentication_TrustResolverService()) && false ?: '_'}, ${($_ = isset($this->services['security.http_utils']) ? $this->services['security.http_utils'] : $this->getSecurity_HttpUtilsService()) && false ?: '_'}, 'feed', $d, NULL, NULL, $c, true), new \Symfony\Bundle\SecurityBundle\Security\FirewallConfig('feed', 'domjudge.user_checker', 'security.request_matcher.4c5f2933d7a2dff6da62864947a9398bddf12e9cce92fc985eda7fdc9072cd90af3a7bd1', true, true, 'security.user.provider.concrete.domjudge_db_provider', NULL, 'security.authentication.basic_entry_point.feed', NULL, NULL, array(0 => 'http_basic', 1 => 'anonymous')));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $h = new \Symfony\Component\Security\Http\Firewall\LogoutListener($a, $e, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($e, '/public'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => 'logout'));
        ...
        $i->setOptions(array('login_path' => 'login', 'use_referer' => true, 'default_target_path' => 'legacy.index', 'always_use_default_target_path' => true, 'target_path_parameter' => '_target_path'));
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => ${($_ = isset($this->services['security.channel_listener']) ? $this->services['security.channel_listener'] : $this->getSecurity_ChannelListenerService()) && false ?: '_'}, 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => ${($_ = isset($this->services['security.user.provider.concrete.domjudge_db_provider']) ? $this->services['security.user.provider.concrete.domjudge_db_provider'] : $this->getSecurity_User_Provider_Concrete_DomjudgeDbProviderService()) && false ?: '_'}), 'main', $b, $c, $d), 2 => $h, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $g, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $e, 'main', $i, $j, array('check_path' => 'login', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $b, $c, $this->get('security.csrf.token_manager')), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '5cad6d05587b46.97074281', $b, $g), 5 => ${($_ = isset($this->services['security.access_listener']) ? $this->services['security.access_listener'] : $this->getSecurity_AccessListenerService()) && false ?: '_'}), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $d, $e, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $e, 'login', false), NULL, NULL, $b, false), new \Symfony\Bundle\SecurityBundle\Security\FirewallConfig('main', 'domjudge.user_checker', 'security.request_matcher.a64d671f18e5575531d76c1d1154fdc4476cb8a79c02ed7a3469178c6d7b96b5ed4e60db', true, false, 'security.user.provider.concrete.domjudge_db_provider', 'main', 'security.authentication.form_entry_point.main', NULL, NULL, array(0 => 'logout', 1 => 'form_login', 2 => 'anonymous')));
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \DOMJudgeBundle\Twig\TwigExtension($this->get('domjudge.domjudge')));
        ...
        $instance->addGlobal('DOMJUDGE_VERSION', '6.0.3');
    ...
    {
        $this->services['twig.loader'] = $instance = new \Symfony\Bundle\TwigBundle\Loader\FilesystemLoader(${($_ = isset($this->services['templating.locator']) ? $this->services['templating.locator'] : $this->getTemplating_LocatorService()) && false ?: '_'}, $this->get('templating.name_parser'), ($this->targetDirs[3].'/app'));

        $instance->addPath(($this->targetDirs[4].'/lib/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views'), 'Framework');
        $instance->addPath(($this->targetDirs[4].'/lib/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views'), 'Security');
        $instance->addPath(($this->targetDirs[4].'/lib/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views'), 'Twig');
        $instance->addPath(($this->targetDirs[4].'/lib/vendor/symfony/swiftmailer-bundle/Resources/views'), 'Swiftmailer');
        $instance->addPath(($this->targetDirs[4].'/lib/vendor/doctrine/doctrine-bundle/Resources/views'), 'Doctrine');
        $instance->addPath(($this->targetDirs[3].'/src/DOMJudgeBundle/Resources/views'), 'DOMJudge');
        $instance->addPath(($this->targetDirs[3].'/app/Resources/views'));
        $instance->addPath(($this->targetDirs[4].'/lib/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form'));
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('JfabAoKShcxvRD0XAUDi');
    }
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->setConstraintValidatorFactory(new \Symfony\Bundle\FrameworkBundle\Validator\ConstraintValidatorFactory($this, array('validator.expression' => 'validator.expression', 'Symfony\\Component\\Validator\\Constraints\\ExpressionValidator' => 'validator.expression', 'Symfony\\Component\\Validator\\Constraints\\EmailValidator' => 'validator.email', 'security.validator.user_password' => 'security.validator.user_password', 'Symfony\\Component\\Security\\Core\\Validator\\Constraints\\UserPasswordValidator' => 'security.validator.user_password', 'doctrine.orm.validator.unique' => 'doctrine.orm.validator.unique', 'Symfony\\Bridge\\Doctrine\\Validator\\Constraints\\UniqueEntityValidator' => 'doctrine.orm.validator.unique', 'DOMJudgeBundle\\Validator\\Constraints\\UserRegistrationValidator' => 'domjudge.user_registration_validator')));
        $instance->setTranslator($this->get('translator'));
        $instance->setTranslationDomain('validators');
        $instance->addXmlMappings(array(0 => ($this->targetDirs[4].'/lib/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml')));
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('FgAXkzwvPD', 0, 'ZzX3CJXmvlWHgjb3N4kh6F', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ikEmYWZ3En', 0, 'ZzX3CJXmvlWHgjb3N4kh6F', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getSecurity_AccessMapService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/index.php$'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/jury-v2'), array(0 => 'ROLE_ADMIN'), NULL);
    ...
    {
        $a = ${($_ = isset($this->services['security.user.provider.concrete.domjudge_db_provider']) ? $this->services['security.user.provider.concrete.domjudge_db_provider'] : $this->getSecurity_User_Provider_Concrete_DomjudgeDbProviderService()) && false ?: '_'};
        $b = $this->get('domjudge.user_checker');
        $c = $this->get('security.encoder_factory');

        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $b, 'api', $c, true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5cad6d05587b46.97074281'), 2 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $b, 'feed', $c, true), 3 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5cad6d05587b46.97074281'), 4 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $b, 'main', $c, true), 5 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5cad6d05587b46.97074281')), true);
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_JURY' => array(0 => 'ROLE_BALLOON', 1 => 'ROLE_API'), 'ROLE_ADMIN' => array(0 => 'ROLE_JURY', 1 => 'ROLE_API'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_ADMIN', 1 => 'ROLE_ALLOWED_TO_SWITCH')));
    }

    /*
     * Gets the 'security.user.provider.concrete.domjudge_db_provider' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getSecurity_User_Provider_Concrete_DomjudgeDbProviderService()
    {
        return $this->services['security.user.provider.concrete.domjudge_db_provider'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'DOMJudgeBundle:User', 'username', NULL);
    }
        ...
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                'FrameworkBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[4].'/lib/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle'),
                    'namespace' => 'Symfony\\Bundle\\FrameworkBundle',
                ),
                'SecurityBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[4].'/lib/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle'),
                    'namespace' => 'Symfony\\Bundle\\SecurityBundle',
                ),
                'TwigBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[4].'/lib/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle'),
                    'namespace' => 'Symfony\\Bundle\\TwigBundle',
                ),
                'MonologBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[4].'/lib/vendor/symfony/monolog-bundle'),
                    'namespace' => 'Symfony\\Bundle\\MonologBundle',
                ),
                'SwiftmailerBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[4].'/lib/vendor/symfony/swiftmailer-bundle'),
                    'namespace' => 'Symfony\\Bundle\\SwiftmailerBundle',
                ),
                'DoctrineBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[4].'/lib/vendor/doctrine/doctrine-bundle'),
                    'namespace' => 'Doctrine\\Bundle\\DoctrineBundle',
                ),
                'SensioFrameworkExtraBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[4].'/lib/vendor/sensio/framework-extra-bundle'),
                    'namespace' => 'Sensio\\Bundle\\FrameworkExtraBundle',
                ),
                'DOMJudgeBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/DOMJudgeBundle'),
                    'namespace' => 'DOMJudgeBundle',
                ),
                'LegacyBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/LegacyBundle'),
                    'namespace' => 'LegacyBundle',
                ),
                'FOSRestBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[4].'/lib/vendor/friendsofsymfony/rest-bundle'),
                    'namespace' => 'FOS\\RestBundle',
                ),
                'JMSSerializerBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[4].'/lib/vendor/jms/serializer-bundle'),
                    'namespace' => 'JMS\\SerializerBundle',
                ),
            ); break;
            case 'domjudge.tmpdir': $value = ($this->targetDirs[4].'/tmp'); break;
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'DOMJudgeBundle' => 'DOMJudgeBundle\\DOMJudgeBundle',
                'LegacyBundle' => 'LegacyBundle\\LegacyBundle',
            ...
            'database_password' => 'AFASTMgceilULG2J',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => 'JfabAoKShcxvRD0XAUDi',
            'domjudge.version' => '6.0.3',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'JfabAoKShcxvRD0XAUDi',
